...
<body>
  ...
  $result = $db->query($sql);
    ...
    $db->close();
        ...
        include('connect.php');
        $a=rand(1,3);
        $sql1 = "SELECT * FROM qn1 WHERE sn=$a";
    ...
    
 {
    ...
    echo "<center><div class='alert alert-success' role='alert'><span><strong>QN</strong>." .$i . "&nbsp; &nbsp;&nbsp;</span><strong>" .$row['ques'] . "</center></strong></div>";
   ...
   echo '<div>';
    ...
    echo '<div style="background-color:rgba(58,47,47,0);background-image:url(&quot;assets/img/footer.png&quot;);background-size:cover;background-repeat:no-repeat;height:366px;">';
       echo '<div class="container">';
        ...
        echo "<script>";
      echo "var copt= ". json_encode($row['copt']). ';';
        echo "function check()";
        echo "{";
        echo "var x = document.getElementById('ans').value;" ;

       echo "if(x==copt){";
       echo " alert('Right Answer ' + x + copt);";
      

       echo "}";
       echo "else";
       echo "{";
       echo " alert('Wrong Answer' + x +copt);";
       echo "}";
