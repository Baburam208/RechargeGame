...
<body>
    ...
    <div id="wrapper">
        <div class="align-content-center align-self-end" id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li> <a href="signupuser.php" style="color:rgb(255,255,255);">Player Sign Up</a><a href="up.php" style="color:rgb(255,255,255);">Update PIN</a><a href="add.php" style="color:rgb(255,255,255);">Add Questions</a></li>
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2">
            <form action="signup.php" method="get" class="custom-form">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" type="email" name="email" required="" placeholder="Email"></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Phone</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="phone" required="" placeholder="Phone"></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Campus</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="campus" value="Pashchimanchal Campus"></div>
                </div><button class="btn btn-light submit-button" type="submit">Register a New Player</button></form>
        </div>
    </div>
