            ...
            <div class="col-10 col-sm-6 col-md-4 offset-1 offset-sm-3 offset-md-4">
                <div class="card">
                    <div class="card-body" style="width:301px;">
                        <h4 class="text-danger card-title">Update Questions</h4>
                        <form action="uqq.php" action="get">
                            ...
                            <div class="form-group"><label>Question</label><textarea class="form-control" rows="12" name="ques" placeholder="Type your Question Here"></textarea></div><button class="btn btn-success btn-block" type="submit">UPDATE</button><button class="btn btn-danger btn-block center-block"
